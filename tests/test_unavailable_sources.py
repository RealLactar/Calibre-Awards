...
class UnavailableAwardSourceCollectionTests(unittest.TestCase):
    ...
    def test_is_separate_from_executable_registries(self):
        ...
        self.assertEqual(len(executable_keys), 19)
        self.assertEqual(len(executable_info_keys), 19)
        ...
        self.assertIn('ipaf', executable_keys)
        self.assertIn('bram_stoker', executable_keys)
        self.assertIn('edgar', executable_keys)
        self.assertIn('romantic_novel_awards', executable_keys)
